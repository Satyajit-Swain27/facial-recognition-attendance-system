...
# # import time
# # import logging
# # from blink_utils import BlinkDetector  # your modular blink detector
# # from database import mark_attendance
# # # Setup logging
# # logging.basicConfig(level=logging.INFO)
# # logger = logging.getLogger("AttendanceSystem")

# # # Load known face encodings and names from pickle
# # try:
...
# # attendance_marked = set()  # To track attendance for session

# # # def mark_attendance(name):
# # #     # Add your attendance DB or CSV logic here
...
# #     # Resize to 75% for better accuracy than 50%
...
# #         # Blink detection and anti-spoof check
# #         face_frame = frame[top:bottom, left:right]
# #         blink_result = blink_detector.detect_blink(face_frame)

# #         if blink_result is True:
# #             if name != "Unknown":
# #                 if mark_attendance(name, "YourClassName"): # <-- from database.py
# #                     logger.info(f"Attendance marked for: {name}")
# #                     print(f"Attendance marked for: {name}")
# #                 else:
...
# #                         cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
# #         else:
# #             cv2.putText(frame, "Blink detection in progress...", (10, frame.shape[0] - 20),
...
# ---- Load class-specific face encodings ----
encoding_file = f"encodings_{class_name}.pickle"
if not os.path.exists(encoding_file):
    logger.error(f"Encoding file not found for class '{class_name}': {encoding_file}")
...
if not known_face_encodings:
    logger.error(f"No encodings found in: {encoding_file}")
    sys.exit(1)
